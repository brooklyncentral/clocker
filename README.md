...
The latest version of Clocker is [1.1.0-PREVIEW.20150831](https://github.com/brooklyncentral/clocker/releases/tag/v1.1.0-PREVIEW.20150831).
...
% wget --no-check-certificate --quiet \
    -O brooklyn-clocker-dist.tar.gz http://git.io/vG2mV
